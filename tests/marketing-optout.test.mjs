...
const state = { version: 2, assistant_disclosure:{version:1,show:false,rendered:true}, history: [], facts, greeted:true,daily_greeting:{day:new Date(now-3*3600000).toISOString().slice(0,10),first:false} };
